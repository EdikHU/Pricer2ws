...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        TheItemDao.createTable(db, ifNotExists);
        TheHolderDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        FactoryDao.dropTable(db, ifExists);
        ProductDao.dropTable(db, ifExists);
        PriceDao.dropTable(db, ifExists);
        RelationDao.dropTable(db, ifExists);
        TheItemDao.dropTable(db, ifExists);
        TheHolderDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(TheItemDao.class);
        registerDaoClass(TheHolderDao.class);
    }
