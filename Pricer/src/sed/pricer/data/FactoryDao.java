...
/** 
 * DAO for table T_FACTORY.
*/
public class FactoryDao extends AbstractDao<Factory, Long> {

    public static final String TABLENAME = "T_FACTORY";
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'T_FACTORY' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'T_FACTORY'";
        db.execSQL(sql);
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Factory entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
